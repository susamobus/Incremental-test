var tokenfuncs = {
    ...
    tokenbuttonsrefresh : function() {
      ...
      if (unlocks.includes("tokens") == true) {
        ...
        document.getElementsByClassName("buyablescosttext")[0].innerHTML = ExpantaNum.mul(100,ExpantaNum.pow(2,tokenvars.tokensupgrades.boughtmore["moresus1"]))
        document.getElementsByClassName("buyablescosttext")[1].innerHTML = ExpantaNum.floor(ExpantaNum.mul(1000,ExpantaNum.pow(2.5,tokenvars.tokensupgrades.boughtmore["morecrewmate1"])))
